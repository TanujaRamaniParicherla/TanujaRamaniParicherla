...
<ul>
  <li><b>Loan Defaulters Prediction</b>
    <ul>
  ...
  <li><b>Enhancing e-Cheque Security Using Elliptic Curve Cryptography</b>
    <ul>
      <li>Designed an authentication system to secure financial e-cheques in the banking sector.</li>
      <li>Focused on cryptographic algorithms for financial security enhancement.</li>
    </ul>
  </li>
  <li
